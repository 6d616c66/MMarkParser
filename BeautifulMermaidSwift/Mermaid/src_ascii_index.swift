...
open class original_src_ascii_index {
    ...
    public static func renderMermaidASCII(
        ...
        case .flowchart:
            ...
            if parsed.direction == "BT" {
                _bmFlipCanvasVertically(&graph.drawGraph.canvas)
                _bmFlipRoleCanvasVertically(&graph.drawGraph.roleCanvas)
            }
    ...
    private static func _bmFlipCanvasVertically(_ canvas: inout [[Character]]) {
    ...
    private static func _bmFlipRoleCanvasVertically(_ roleCanvas: inout RoleCanvas) {
