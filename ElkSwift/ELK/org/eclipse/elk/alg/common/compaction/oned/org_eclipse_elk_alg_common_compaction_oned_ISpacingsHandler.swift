 ...
 */
internal protocol ISpacingsHandler {
...
extension ISpacingsHandler {
     ...
     */
    internal static var DEFAULT_SPACING_HANDLER: ISpacingsHandler {
        return DefaultSpacingsHandler()
    }
}

internal class DefaultSpacingsHandler: ISpacingsHandler {
    internal func getHorizontalSpacing(_ cNode1: CNode, _ cNode2: CNode) -> Double {
        return 0.0
    }
    
    internal func getVerticalSpacing(_ cNode1: CNode, _ cNode2: CNode) -> Double {
        return 0.0
    }
}
