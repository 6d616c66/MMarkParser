...
internal enum ContainerArea: Int, CaseIterable {
    ...
    internal var ordinal: Int { rawValue }

    // MARK: - Uppercase Aliases (Java compatibility)
    internal static let BEGIN = ContainerArea.begin
    internal static let CENTER = ContainerArea.center
    internal static let END = ContainerArea.end

    /// Java-compatible values array.
    internal static var values: [ContainerArea] { return ContainerArea.allCases }

    /// Number of container areas.
    internal static var count: Int { return allCases.count }
}
