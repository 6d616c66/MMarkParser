...
/**
 * A container cell contains other cells. How it contains them depends on the actual container cell. This internal class
 ...
 */
internal class ContainerCell: Cell {
    
    /**
     * Compute x coordinates and widths of children.
     */
    internal func layoutChildrenHorizontally() {
     ...
     */
    internal func layoutChildrenVertically() {
        assertionFailure("Subclass must override")
    }
     ...
     */
    internal static func minWidthOfCell(_ cell: Cell?, respectContributionFlag: Bool) -> Double {
     ...
     */
    internal static func minHeightOfCell(_ cell: Cell?, respectContributionFlag: Bool) -> Double {
     ...
     */
    internal func applyHorizontalLayout(_ cell: Cell?, x: Double, width: Double) {
     ...
     */
    internal func applyVerticalLayout(_ cell: Cell?, y: Double, height: Double) {
        guard let cell = cell else { return }
