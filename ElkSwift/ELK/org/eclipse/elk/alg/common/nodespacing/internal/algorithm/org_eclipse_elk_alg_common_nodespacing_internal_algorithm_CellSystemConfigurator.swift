 ...
 * calculation.
 */
internal final class CellSystemConfigurator {

    private init() {}

    // MARK: - Size Contribution Configuration

    internal static func configureCellSystemSizeContributions(_ nodeContext: NodeContext) {
    ...
    internal static func updateVerticalInsidePortLabelCellPadding(_ nodeContext: NodeContext) {
