 ...
 */
internal final class HorizontalPortPlacementSizeCalculator {

    private init() {}

    internal static func calculateHorizontalPortPlacementSize(_ nodeContext: NodeContext) {
    ...
    internal static func calculateHorizontalNodeSizeRequiredByFixedPosPorts(_ nodeContext: NodeContext, _ portSide: PortSide) {
    ...
    internal static func calculateHorizontalNodeSizeRequiredByFixedRatioPorts(_ nodeContext: NodeContext, _ portSide: PortSide) {
    ...
    internal static let equalityTolerance: Double = 0.01

    internal static func minSizeRequiredToRespectSpacing(_ spacing: Double, _ firstRatio: Double, _ secondRatio: Double) -> Double {
    ...
    internal static func calculateHorizontalNodeSizeRequiredByFreePorts(_ nodeContext: NodeContext, _ portSide: PortSide) {
        guard let cell = nodeContext.insidePortLabelCells[portSide] else { return }
    ...
    internal static func setupPortMargins(_ nodeContext: NodeContext, _ portSide: PortSide) {
        let portContexts = nodeContext.portContexts[portSide] ?? []
    ...
    internal static func computeHorizontalPortMargins(_ nodeContext: NodeContext, _ portSide: PortSide, _ portLabelsOutside: Bool) {
        let portContexts = nodeContext.portContexts[portSide] ?? []
    ...
    internal static func unifyPortMargins(_ portContexts: [PortContext]) {
    ...
    internal static func portWidthPlusPortPortSpacing(_ nodeContext: NodeContext, _ portSide: PortSide) -> Double {
        var result: Double = 0
