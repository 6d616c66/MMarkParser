 ...
 */
internal final class InsidePortLabelCellCreator {

    private init() {}

    // MARK: - Public Methods

    internal static func createInsidePortLabelCells(_ nodeContext: NodeContext) {
    ...
    internal static func createInsidePortLabelCell(_ nodeContext: NodeContext,
    ...
    internal static func setupNorthOrSouthPortLabelCell(_ nodeContext: NodeContext, _ portSide: PortSide) {
    ...
    internal static func setupEastOrWestPortLabelCell(_ nodeContext: NodeContext, _ portSide: PortSide) {
    ...
    internal static func calculateWidthDueToLabels(_ nodeContext: NodeContext, _ portSide: PortSide) {
    ...
    internal static func setupTopAndBottomPadding(_ nodeContext: NodeContext, _ portSide: PortSide) {
        let surroundingPortMargins = nodeContext.surroundingPortMargins
        guard let cell = nodeContext.insidePortLabelCells[portSide] else { return }
        let padding = cell.padding
