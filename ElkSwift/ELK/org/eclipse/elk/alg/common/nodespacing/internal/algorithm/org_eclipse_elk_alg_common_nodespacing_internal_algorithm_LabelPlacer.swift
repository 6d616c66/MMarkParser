 ...
 */
internal final class LabelPlacer {
     ...
     */
    internal static func placeLabels(_ nodeContext: NodeContext) {
    ...
    internal static func placeOuterNodeLabelContainers(_ nodeContext: NodeContext) {
    ...
    internal static func placeHorizontalOuterNodeLabelContainer(_ nodeContext: NodeContext,
    ...
    internal static func placeVerticalOuterNodeLabelContainer(_ nodeContext: NodeContext,
            outerNodeLabelsOverhang: Bool, portSide: PortSide) {
