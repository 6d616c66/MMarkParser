 ...
 */
internal final class NodeLabelAndSizeUtilities {

    private init() {}

    // MARK: - Algorithm Phase Implementation Fragments

    internal static func setupMinimumClientAreaSize(_ nodeContext: NodeContext) {
    ...
    internal static func setupNodePaddingForPortsWithOffset(_ nodeContext: NodeContext) {
    ...
    internal static func offsetSouthernPortsByNodeSize(_ nodeContext: NodeContext) {
    ...
    internal static func setNodePadding(_ nodeContext: NodeContext) {
    ...
    internal static func applyStuff(_ nodeContext: NodeContext) {
    ...
    internal static func getMinimumClientAreaSize(_ nodeContext: NodeContext) -> KVector? {
    ...
    internal static func getMinimumNodeSize(_ nodeContext: NodeContext) -> KVector? {
        if nodeContext.sizeConstraints.contains(.minimumSize) {
    ...
    internal static func getMinimumNodeOrClientAreaSize(_ nodeContext: NodeContext) -> KVector {
    ...
    internal static let EFFECTIVELY_FIXED_SIZE_CONSTRAINTS: SizeConstraint = [.portLabels]

    internal static func areSizeConstraintsFixed(_ nodeContext: NodeContext) -> Bool {
        return nodeContext.sizeConstraints.isEmpty
                || (nodeContext.sizeConstraints == EFFECTIVELY_FIXED_SIZE_CONSTRAINTS)
    }

    internal static func isFirstOutsidePortLabelPlacedDifferently(_ nodeContext: NodeContext,
