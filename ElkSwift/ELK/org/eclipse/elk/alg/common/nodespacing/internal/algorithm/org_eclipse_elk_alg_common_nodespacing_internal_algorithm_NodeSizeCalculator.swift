 ...
 */
internal final class NodeSizeCalculator {

    private init() {}

    // MARK: - Node Width

    internal static func setNodeWidth(_ nodeContext: NodeContext) {
    ...
    internal static func setNodeHeight(_ nodeContext: NodeContext) {
        let nodeSize = nodeContext.nodeSize
        var height: Double
