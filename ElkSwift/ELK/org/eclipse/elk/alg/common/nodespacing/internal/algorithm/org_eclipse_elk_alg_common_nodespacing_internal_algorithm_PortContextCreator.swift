 ...
 */
internal final class PortContextCreator {
     ...
     */
    internal static func createPortContexts(_ nodeContext: NodeContext, ignoreInsidePortLabels: Bool) {
     ...
     */
    internal static func createPortContext(_ nodeContext: NodeContext, _ port: PortAdapter, _ imPortLabels: Bool) {
