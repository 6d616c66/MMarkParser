 ...
 */
internal final class PortLabelPlacementCalculator {

    private init() {}

    internal static func placeHorizontalPortLabels(_ nodeContext: NodeContext) {
        placePortLabels(nodeContext, .NORTH)
        placePortLabels(nodeContext, .SOUTH)
    }

    internal static func placeVerticalPortLabels(_ nodeContext: NodeContext) {
        placePortLabels(nodeContext, .EAST)
        placePortLabels(nodeContext, .WEST)
    }

    internal static func placePortLabels(_ nodeContext: NodeContext, _ portSide: PortSide) {
    ...
    internal static func simpleInsidePortLabelPlacement(_ nodeContext: NodeContext, _ portSide: PortSide) {
    ...
    internal static func portLabelBorderOffsetForPortSide(_ nodeContext: NodeContext, _ portSide: PortSide) -> Double {
        switch portSide {
        case .NORTH:
    ...
    internal static func constrainedInsidePortLabelPlacement(_ nodeContext: NodeContext, _ portSide: PortSide) {
    ...
    internal static func centerPortLabel(_ portLabelCellRect: ElkRectangle, _ portPosition: KVector,
    ...
    internal static func simpleOutsidePortLabelPlacement(_ nodeContext: NodeContext, _ portSide: PortSide) {
        guard let portContexts = nodeContext.portContexts[portSide] else { return }
    ...
    internal static func constrainedOutsidePortLabelPlacement(_ nodeContext: NodeContext, _ portSide: PortSide) {
        guard let portContexts = nodeContext.portContexts[portSide] else { return }
