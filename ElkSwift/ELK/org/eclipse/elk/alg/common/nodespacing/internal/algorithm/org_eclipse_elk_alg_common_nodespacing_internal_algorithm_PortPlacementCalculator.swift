 ...
 */
internal final class PortPlacementCalculator {

    internal static let PORT_RATIO_OR_POSITION: IProperty = Property<Double>(
    ...
    internal static func placeHorizontalPorts(_ nodeContext: NodeContext) {
    ...
    internal static func placeHorizontalFixedPosPorts(_ nodeContext: NodeContext, _ portSide: PortSide) {
    ...
    internal static func placeHorizontalFixedRatioPorts(_ nodeContext: NodeContext, _ portSide: PortSide) {
    ...
    internal static func placeHorizontalFreePorts(_ nodeContext: NodeContext, _ portSide: PortSide) {
    ...
    internal static func calculateHorizontalPortYCoordinate(_ portContext: PortContext) -> Double {
    ...
    internal static func placeVerticalPorts(_ nodeContext: NodeContext) {
        switch nodeContext.portConstraints {
        case .fixedPos:
    ...
    internal static func placeVerticalFixedPosPorts(_ nodeContext: NodeContext, _ portSide: PortSide) {
        let nodeWidth = nodeContext.nodeSize.x
    ...
    internal static func placeVerticalFixedRatioPorts(_ nodeContext: NodeContext, _ portSide: PortSide) {
    ...
    internal static func placeVerticalFreePorts(_ nodeContext: NodeContext, _ portSide: PortSide) {
        guard let portContexts = nodeContext.portContexts[portSide], !portContexts.isEmpty else {
            return
        }
    ...
    internal static func calculateVerticalPortXCoordinate(_ portContext: PortContext, _ nodeWidth: Double) -> Double {
        let port = portContext.port
        if port.hasProperty(CoreOptions.PORT_BORDER_OFFSET) {
            let offset: Double = port.getProperty(CoreOptions.PORT_BORDER_OFFSET) ?? 0.0
    ...
    internal static func modifiedPortPlacementSize(_ nodeContext: NodeContext,
