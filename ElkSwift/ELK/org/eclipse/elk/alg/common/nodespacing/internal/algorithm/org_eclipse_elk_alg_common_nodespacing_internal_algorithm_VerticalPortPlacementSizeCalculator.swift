 ...
 */
internal final class VerticalPortPlacementSizeCalculator {

    private init() {}

    internal static func calculateVerticalPortPlacementSize(_ nodeContext: NodeContext) {
    ...
    internal static func calculateVerticalNodeSizeRequiredByFixedPosPorts(_ nodeContext: NodeContext, _ portSide: PortSide) {
    ...
    internal static func calculateVerticalNodeSizeRequiredByFixedRatioPorts(_ nodeContext: NodeContext, _ portSide: PortSide) {
    ...
    internal static func calculateVerticalNodeSizeRequiredByFreePorts(_ nodeContext: NodeContext, _ portSide: PortSide) {
    ...
    internal static func computeVerticalPortMargins(_ nodeContext: NodeContext, _ portSide: PortSide,
    ...
    internal static func portHeightPlusPortPortSpacing(_ nodeContext: NodeContext, _ portSide: PortSide) -> Double {
        var result: Double = 0
