 ...
 */
internal enum NodeLabelLocation: CaseIterable {
    // Outside placements
    case OUT_T_L
    case OUT_T_C
    case OUT_T_R
    ...
    internal static func fromNodeLabelPlacement(_ labelPlacement: NodeLabelPlacement) -> NodeLabelLocation {
    ...
    internal var horizontalAlignment: HorizontalLabelAlignment {
        switch self {
    ...
    internal var verticalAlignment: VerticalLabelAlignment {
        switch self {
    ...
    internal var containerRow: ContainerArea {
        switch self {
    ...
    internal var containerColumn: ContainerArea {
        switch self {
        case .OUT_T_L, .OUT_B_L, .OUT_L_T, .OUT_L_C, .OUT_L_B, .IN_T_L, .IN_B_L, .IN_C_L:
            return .begin
        case .OUT_T_R, .OUT_B_R, .OUT_R_T, .OUT_R_C, .OUT_R_B, .IN_T_R, .IN_B_R, .IN_C_R:
    ...
    /// Java-style getters
    internal func getContainerRow() -> ContainerArea {
        return containerRow
    }

    internal func getContainerColumn() -> ContainerArea {
        return containerColumn
    }

    // MARK: - Helper Methods

    internal func isInsideLocation() -> Bool {
        switch self {
    ...
    internal func getOutsideSide() -> PortSide {
        switch self {
