 ...
 * labels, ports, etc.
 */
internal final class NodeDimensionCalculation {
     ...
     * are sorted properly.
     */
    internal static func calculateLabelAndNodeSizes(_ adapter: GraphAdapter) {
     ...
     */
    internal static func calculateNodeMargins(_ adapter: GraphAdapter) {
     ...
     * process() method.
     */
    internal static func getNodeMarginCalculator(_ adapter: GraphAdapter) -> NodeMarginCalculator {
     ...
     */
    internal static func sortPortLists(_ adapter: GraphAdapter) {
