 ...
 */
internal final class NodeLabelAndSizeCalculator {
     ...
     */
    internal static func process(_ graph: GraphAdapter) {
     ...
     */
    @discardableResult
    internal static func process(_ graph: GraphAdapter, _ node: NodeAdapter, _ applyStuff: Bool,
     ...
     */
    internal static func computeInsideNodeLabelPadding(_ graph: GraphAdapter, _ node: NodeAdapter,
