 ...
 */
internal final class GreedyRectangleStripOverlapRemover: IRectangleStripOverlapRemovalStrategy {

    internal init() {}

    internal func removeOverlaps(_ overlapRemover: RectangleStripOverlapRemover) -> Double {
