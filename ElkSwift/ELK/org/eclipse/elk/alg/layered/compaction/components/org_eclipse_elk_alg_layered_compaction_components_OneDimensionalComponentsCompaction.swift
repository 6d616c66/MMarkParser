...
internal final class OneDimensionalComponentsCompaction<N, E> {
    ...
    internal static func initCompaction(_ ccs: InternalConnectedComponents, spacing: Double) -> OneDimensionalComponentsCompaction<N, E> {
    ...
    internal func compact(monitor: Any) {
