...
internal final class CGroup {
     ...
     */
    internal init(_ inputCNodes: CNode...) {
        cNodes = Set<CNode>()
     ...
     */
    internal func addCNode(_ cNode: CNode) {
        cNodes.insert(cNode)
        if cNode.cGroup != nil {
     ...
     */
    internal func removeCNode(_ cNode: CNode) -> Bool {
