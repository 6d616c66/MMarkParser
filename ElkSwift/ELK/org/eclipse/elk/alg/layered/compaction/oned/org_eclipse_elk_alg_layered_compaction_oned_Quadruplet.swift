 ...
 */
internal final class Quadruplet {
    
    // SUPPRESS CHECKSTYLE NEXT 2 VisibilityModifier
    /** Locking values. */
    internal var left: Bool = false
    internal var right: Bool = false
    internal var up: Bool = false
    internal var down: Bool = false
     ...
     */
    internal init(_ l: Bool, _ r: Bool, _ u: Bool, _ d: Bool) {
        left = l
        right = r
        up = u
        down = d
     ...
     *   - d: down
     */
    internal func set(_ l: Bool, _ r: Bool, _ u: Bool, _ d: Bool) {
        left = l
        right = r
        up = u
        down = d
     ...
     */
    internal func set(_ value: Bool, direction: Direction) {
        switch direction {
        case .LEFT:
            left = value
        case .RIGHT:
     ...
     * - Returns: the state
     */
    internal func get(direction: Direction) -> Bool {
        switch direction {
        case .LEFT:
            return left
        case .RIGHT:
