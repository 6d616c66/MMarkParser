 ...
 * algorithm.
 */
internal class AbstractGraphPlacer {
     ...
     */
    internal func combine(_ components: [LGraph], target: LGraph) { assertionFailure("Subclass must override") }

    /**
     * Move the source graphs into the destination graph using a specified offset.
     */
    internal func moveGraphs(_ destGraph: LGraph, _ sourceGraphs: [LGraph], _ offsetx: Double, _ offsety: Double) {
     ...
     */
    internal func moveGraph(_ destGraph: LGraph, _ sourceGraph: LGraph, _ offsetx: Double, _ offsety: Double) {
     ...
     */
    internal func offsetGraphs(_ graphs: [LGraph], _ offsetx: Double, _ offsety: Double) {
        for graph in graphs {
     ...
     */
    internal func offsetGraph(_ graph: LGraph, _ offsetx: Double, _ offsety: Double) {
