...
internal class ComponentGroup {
     ...
     */
    internal static let constraints: [Set<PortSide>: [Set<PortSide>]] = {
     ...
     */
    internal var components: [Set<PortSide>: [LGraph]] = [:]
     ...
     */
    internal init(_ component: LGraph) {
        add(component)
    }
     ...
     */
    @discardableResult
    internal func add(_ component: LGraph) -> Bool {
        if canAdd(component) {
     ...
     *         otherwise.
     */
    internal func canAdd(_ component: LGraph) -> Bool {
     ...
     */
    internal func getPortSides() -> [Set<PortSide>] {
        return Array(components.keys)
    }

    /// Convenience property for port sides.
    internal var portSides: [Set<PortSide>] {
        return Array(components.keys)
    }
     ...
     */
    internal func getComponents() -> [LGraph] {
     ...
     *         returned.
     */
    internal func getComponents(_ connections: Set<PortSide>) -> [LGraph] {
