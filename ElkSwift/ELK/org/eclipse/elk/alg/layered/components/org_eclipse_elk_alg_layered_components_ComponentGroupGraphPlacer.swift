 ...
 * ports into account.
 */
internal class ComponentGroupGraphPlacer: AbstractGraphPlacer {

    // MARK: - Variables

    internal var componentGroups = [ComponentGroup]()

    // MARK: - AbstractGraphPlacer

    internal override func combine(_ components: [LGraph], target: LGraph) {
    ...
    internal func addComponent(_ component: LGraph) {
        for group in componentGroups {
    ...
    internal func placeComponents(_ group: ComponentGroup, spacing: Double) -> KVector {
    ...
    internal func placeComponentsHorizontally(_ components: [LGraph], spacing: Double) -> KVector {
        var size = KVector()
    ...
    internal func placeComponentsVertically(_ components: [LGraph], spacing: Double) -> KVector {
        var size = KVector()
    ...
    internal func placeComponentsInRows(_ components: [LGraph], spacing: Double) -> KVector {
