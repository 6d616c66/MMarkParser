 ...
 */
internal class ModelOrderComponentGroup: ComponentGroup {
     ...
     */
    internal static let modelOrderConstraints: [Set<PortSide>: [Set<PortSide>]] = {
    ...
    internal var componentOrder: [LGraph] = []
     ...
     */
    internal override init(_ component: LGraph) {
        super.init()
        _ = add(component)
     ...
     */
    @discardableResult
    internal override func add(_ component: LGraph) -> Bool {
        if canAdd(component) {
     ...
     *         otherwise.
     */
    internal override func canAdd(_ component: LGraph) -> Bool {
     ...
     */
    internal func getComponentOrder() -> [LGraph] {
     ...
     */
    internal override var portSides: [Set<PortSide>] {
