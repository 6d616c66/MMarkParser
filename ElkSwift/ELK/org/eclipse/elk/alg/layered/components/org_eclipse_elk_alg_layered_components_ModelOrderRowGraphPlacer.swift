 ...
 */
internal class ModelOrderRowGraphPlacer: SimpleRowGraphPlacer {

    internal override func sortComponents(_ components: [LGraph], target: LGraph) {
        // Does nothing since components are already sorted by model order
    }

    internal override func placeComponents(_ components: [LGraph], target: LGraph, maxRowWidth: Double, componentSpacing: Double) {
