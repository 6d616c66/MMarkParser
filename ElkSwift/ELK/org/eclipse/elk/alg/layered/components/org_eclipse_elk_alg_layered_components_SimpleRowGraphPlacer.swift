 ...
 * one component.</p>
 */
internal class SimpleRowGraphPlacer: AbstractGraphPlacer {
     ...
     */
    internal func sortComponents(_ components: [LGraph], target: LGraph) {
     ...
     */
    internal func placeComponents(_ components: [LGraph], target: LGraph, maxRowWidth: Double, componentSpacing: Double) {
