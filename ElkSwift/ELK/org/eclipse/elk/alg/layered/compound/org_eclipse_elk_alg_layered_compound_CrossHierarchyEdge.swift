...
internal class CrossHierarchyEdge {
     ...
     */
    internal init(_ newEdge: LEdge, _ graph: LGraph, _ type: PortType) {
     ...
     */
    internal func getType() -> PortType {
        return type
    }
     ...
     */
    internal func getActualSource() -> LPort {
     ...
     */
    internal func getActualTarget() -> LPort {
