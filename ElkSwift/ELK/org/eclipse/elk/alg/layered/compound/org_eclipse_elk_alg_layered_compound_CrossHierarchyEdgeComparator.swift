 ...
 * segment.
 */
internal final class CrossHierarchyEdgeComparator {
    ...
    internal func compare(_ edge1: CrossHierarchyEdge, _ edge2: CrossHierarchyEdge) -> ComparisonResult {
     ...
     */
    internal static func hierarchyLevel(_ nestedGraph: LGraph, top topLevelGraph: LGraph) -> Int {
