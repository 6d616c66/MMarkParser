...
internal class Tarjan {
    ...
    internal var edgesToBeReversed: [LEdge]
    internal var index = 0
    internal var stronglyConnectedComponents: [[LNode]] // FIXME Why no ordered set here? this is bad
    internal var stack: [LNode] = []
    internal var nodeToSCCID: [LNode: Int] = [:]
    
    internal init(edgesToBeReversed: [LEdge],
    ...
    internal func tarjan(_ graph: LGraph) {
        index = 0
        stack.removeAll()
    ...
    internal func stronglyConnected(_ v: LNode) {
    ...
    internal func resetTarjan(_ graph: LGraph) {
