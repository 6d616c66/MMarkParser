...
internal class org_eclipse_elk_alg_layered_intermediate_compaction_HorizontalGraphCompactor {
    internal init() {}

    internal func process(_ layeredGraph: LGraph, _ progressMonitor: IElkProgressMonitor) {
