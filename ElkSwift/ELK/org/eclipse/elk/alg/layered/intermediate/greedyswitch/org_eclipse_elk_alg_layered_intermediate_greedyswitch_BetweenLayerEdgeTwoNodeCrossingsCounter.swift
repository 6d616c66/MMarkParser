...
internal final class org_eclipse_elk_alg_layered_intermediate_greedyswitch_BetweenLayerEdgeTwoNodeCrossingsCounter {
    ...
    internal init(_ currentNodeOrder: [[LNode]], _ freeLayerIndex: Int) {
    ...
    internal func countEasternEdgeCrossings(_ upperNode: LNode, _ lowerNode: LNode) {
        resetCrossingCount()
        if upperNode === lowerNode { return }
        addEasternCrossings(upperNode, lowerNode)
    }

    internal func countWesternEdgeCrossings(_ upperNode: LNode, _ lowerNode: LNode) {
        resetCrossingCount()
        if upperNode === lowerNode { return }
        addWesternCrossings(upperNode, lowerNode)
    }

    internal func countBothSideCrossings(_ upperNode: LNode, _ lowerNode: LNode) {
        resetCrossingCount()
        if upperNode === lowerNode { return }
        addWesternCrossings(upperNode, lowerNode)
        addEasternCrossings(upperNode, lowerNode)
    ...
    internal func getUpperLowerCrossings() -> Int {
        upperLowerCrossings
    }

    internal func getLowerUpperCrossings() -> Int {
        lowerUpperCrossings
    }
}
