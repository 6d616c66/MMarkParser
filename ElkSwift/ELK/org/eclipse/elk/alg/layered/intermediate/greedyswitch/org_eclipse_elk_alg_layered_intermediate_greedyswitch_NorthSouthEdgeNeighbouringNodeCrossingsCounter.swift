...
internal class org_eclipse_elk_alg_layered_intermediate_greedyswitch_NorthSouthEdgeNeighbouringNodeCrossingsCounter {
    ...
    internal func countCrossings(_ upperNode: LNode, _ lowerNode: LNode) {
