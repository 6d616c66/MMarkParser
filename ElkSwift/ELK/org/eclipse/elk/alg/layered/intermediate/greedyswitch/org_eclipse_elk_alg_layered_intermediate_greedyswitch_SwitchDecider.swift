...
internal final class org_eclipse_elk_alg_layered_intermediate_greedyswitch_SwitchDecider {

    internal enum CrossingCountSide {
        case WEST
        case EAST
    }
    ...
    internal func notifyOfSwitch(_ upperNode: LNode, _ lowerNode: LNode) {
    ...
    internal func doesSwitchReduceCrossings(_ upperNodeIndex: Int, _ lowerNodeIndex: Int) -> Bool {
