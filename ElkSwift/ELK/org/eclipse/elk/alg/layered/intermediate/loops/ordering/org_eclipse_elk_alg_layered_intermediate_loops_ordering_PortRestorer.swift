...
internal final class org_eclipse_elk_alg_layered_intermediate_loops_ordering_PortRestorer {
    ...
    internal func restorePorts(_ slHolder: SelfLoopHolder, _ monitor: IElkProgressMonitor) {
        initTargetAreas()
    ...
    internal static func sortedTwoSideLoopPortSides(_ slLoop: SelfHyperLoop) -> [PortSide] {
