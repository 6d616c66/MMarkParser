...
internal final class org_eclipse_elk_alg_layered_intermediate_loops_SelfLoopHolder {
    ...
    internal static func install(_ lNode: LNode) -> SelfLoopHolder {
    ...
    internal static func needsSelfLoopProcessing(_ lNode: LNode) -> Bool {
    ...
    internal func getLNode() -> LNode {
        return lNode
    }

    internal func getSLHyperLoops() -> [SelfHyperLoop] {
        return slHyperLoops
    }

    internal func getSLPortMap() -> [ObjectIdentifier: SelfLoopPort] {
        return slPortsMap
    }

    /// Returns the ordered list of SelfLoopPorts (preserving insertion order like Java's LinkedHashMap.values()).
    internal func getSLPortValues() -> [SelfLoopPort] {
        return slPortsList
    }

    internal func arePortsHidden() -> Bool {
        return portsHiddenValue
    }

    internal func setPortsHidden(_ hidden: Bool) {
        self.portsHiddenValue = hidden
    }

    internal func getRoutingSlotCount() -> RoutingSlotCountArray {
...
internal final class RoutingSlotCountArray {
