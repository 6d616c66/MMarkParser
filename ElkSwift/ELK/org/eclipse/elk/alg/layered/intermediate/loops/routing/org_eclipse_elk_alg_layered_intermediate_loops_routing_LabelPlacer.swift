...
internal final class org_eclipse_elk_alg_layered_intermediate_loops_routing_LabelPlacer {

    internal init() {}

    internal func placeLabels(_ slHolder: SelfLoopHolder, _ labelManager: ILabelManager?,
