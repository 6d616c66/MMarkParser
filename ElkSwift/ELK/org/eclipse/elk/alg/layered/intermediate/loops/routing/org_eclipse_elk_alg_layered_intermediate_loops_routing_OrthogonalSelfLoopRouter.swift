...
internal class org_eclipse_elk_alg_layered_intermediate_loops_routing_OrthogonalSelfLoopRouter: AbstractSelfLoopRouter {

    internal enum EdgeRoutingDirection {
        case CLOCKWISE
    ...
    internal override func routeSelfLoops(_ slHolder: SelfLoopHolder) {
