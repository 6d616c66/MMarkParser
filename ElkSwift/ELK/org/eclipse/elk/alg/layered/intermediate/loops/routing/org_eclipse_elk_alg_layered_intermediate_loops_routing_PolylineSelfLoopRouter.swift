...
internal class org_eclipse_elk_alg_layered_intermediate_loops_routing_PolylineSelfLoopRouter: OrthogonalSelfLoopRouter {
    ...
    internal func cutCorners(_ bendPoints: KVectorChain, _ distance: Double) -> KVectorChain {
