...
internal final class org_eclipse_elk_alg_layered_intermediate_loops_routing_RoutingDirector {
    ...
    internal func determineLoopRoutes(_ slHolder: SelfLoopHolder) {
