 ...
 * </dl>
 */
internal final class CommentPostprocessor: ILayoutProcessor {
     ...
     */
    internal func process(_ node: LNode, topBoxes: [LNode]?, bottomBoxes: [LNode]?) {
     ...
     * corresponding node.
     */
    internal func getBoxPort(_ commentBox: LNode) -> LPort {
