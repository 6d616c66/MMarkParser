 ...
 * </dl>
 */
internal final class CommentPreprocessor: ILayoutProcessor {
     ...
     */
    internal func processBox(box: LNode, edge: LEdge, oppositePort: LPort, realNode: LNode) {
        var topFirst = false
        var onlyTop = false
    ...
    internal func removeHierarchicalPortDummyNode(_ oppositePort: LPort) {
