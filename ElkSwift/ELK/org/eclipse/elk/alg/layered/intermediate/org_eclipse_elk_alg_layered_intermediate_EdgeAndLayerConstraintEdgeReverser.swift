 ...
 */
internal final class EdgeAndLayerConstraintEdgeReverser: ILayoutProcessor {
     ...
     */
    internal func handleOuterNodes(_ layeredGraph: LGraph) -> [LNode] {
     ...
     */
    internal func handleInnerNodes(_ layeredGraph: LGraph, _ remainingNodes: [LNode]) {
    ...
    internal func reverseEdges(_ layeredGraph: LGraph, node: LNode, nodeLayerConstraint: LayerConstraint, targetPortType: PortType) {
    ...
    internal func canReverseOutgoingEdge(_ sourceNodeLayerConstraint: LayerConstraint, _ edge: LEdge) -> Bool {
    ...
    internal func canReverseIncomingEdge(_ targetNodeLayerConstraint: LayerConstraint, _ edge: LEdge) -> Bool {
        // If the edge is already reversed, we don't want to reverse it again
        if edge.getProperty(InternalProperties.REVERSED) as? Bool ?? false {
            return false
        }
