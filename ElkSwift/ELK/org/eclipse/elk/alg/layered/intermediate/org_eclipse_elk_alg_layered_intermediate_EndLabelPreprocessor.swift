...
internal class EndLabelPreprocessor {

    internal init() {}

    internal func process(_ layeredGraph: LGraph, monitor: IElkProgressMonitor) {
    ...
    internal func processNode(_ node: LNode, edgeLabelSpacing: Double, labelLabelSpacing: Double, verticalLayout: Bool) {
     ...
     */
    internal func createConfiguredLabelCell(_ labels: [LLabel]?, labelLabelSpacing: Double, verticalLayout: Bool) -> LabelCell? {
    ...
    internal static let NO_INCIDENT_EDGE_THICKNESS: Double = -1

    /**
     * Returns a list that contains all end labels to be placed at the given port.
     */
    internal static func gatherLabels(port: LPort) -> [LLabel]? {
        var labels: [LLabel] = []
     ...
     */
    internal static func gatherLabels(port: LPort, targetList: inout [LLabel]) -> Double {
     ...
     */
    internal func placeLabels(node: LNode, portLabelCells: [LabelCell?], labelLabelSpacing: Double, edgeLabelSpacing: Double, verticalLayout: Bool) {
     ...
     */
    internal func placeLabels(port: LPort, labelCell: LabelCell, edgeLabelSpacing: Double) {
     ...
     */
    internal func updateNodeMargins(node: LNode, labelCells: [LabelCell?]) {
     ...
     */
    internal func getLabelSide(_ labelCell: LabelCell) -> LabelSide {
     ...
     */
    internal func maxEdgeThickness(port: LPort) -> Double {
     ...
     */
    internal func portSideToOverlapRemovalDirection(_ portSide: PortSide) -> RectangleStripOverlapRemover.OverlapRemovalDirection {
        switch portSide {
        case .NORTH:
            return .up
        case .SOUTH:
