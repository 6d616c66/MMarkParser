...
internal final class EndLabelSorter: ILayoutProcessor {
    ...
    internal func processNode(_ node: LNode) {
     ...
     */
    internal func needsSorting(_ port: LPort) -> Bool {
     ...
     */
    internal func initialize(_ lGraph: LGraph) {
        var nextElementID = 0
        for layer in lGraph {
     ...
     */
    internal func sort(port: LPort, portLabelCell: LabelCell) {
     ...
     */
    internal func createLabelGroups(_ portLabelCell: LabelCell) -> [LabelGroup] {
     ...
     */
    internal class LabelGroup {

        /** The edge the labels belong to. */
        internal let edge: LEdge
    ...
    internal static let LABEL_GROUP_COMPARATOR: (LabelGroup, LabelGroup) -> Bool = { group1, group2 in
