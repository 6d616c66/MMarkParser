...
internal final class org_eclipse_elk_alg_layered_intermediate_GraphTransformer {

    internal var mode: org_eclipse_elk_alg_layered_intermediate_GraphTransformer_Mode = .defaults

    internal init() {}

    internal init(_ mode: org_eclipse_elk_alg_layered_intermediate_GraphTransformer_Mode) {
        self.mode = mode
    }
