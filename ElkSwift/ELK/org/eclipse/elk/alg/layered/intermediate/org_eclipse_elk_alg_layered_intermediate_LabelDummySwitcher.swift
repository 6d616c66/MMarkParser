...
internal final class org_eclipse_elk_alg_layered_intermediate_LabelDummySwitcher {

    internal static let INCLUDE_LABEL = Property<Bool>("edgelabelcenterednessanalysis.includelabel")
