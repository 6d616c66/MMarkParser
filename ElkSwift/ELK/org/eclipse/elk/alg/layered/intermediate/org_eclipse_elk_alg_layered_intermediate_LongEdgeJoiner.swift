...
internal final class org_eclipse_elk_alg_layered_intermediate_LongEdgeJoiner {
    internal init() {}
    ...
    internal static func joinAt(_ longEdgeDummy: LNode, _ addUnnecessaryBendpoints: Bool) {
