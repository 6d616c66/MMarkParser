...
internal final class org_eclipse_elk_alg_layered_intermediate_PortListSorter {
    internal typealias Comparator = (LPort, LPort) -> Int

    internal static let CMP_PORT_SIDE: Comparator = { p1, p2 in
        p1.side.ordinal - p2.side.ordinal
    }

    internal static let CMP_PORT_DEGREE_EAST_WEST: Comparator = { p1, p2 in
    ...
    internal static let CMP_FIXED_ORDER_AND_FIXED_POS: Comparator = { p1, p2 in
    ...
    internal static let CMP_COMBINED: Comparator = { p1, p2 in
    ...
    internal static func compareDouble(_ lhs: Double, _ rhs: Double) -> Int {
        if lhs < rhs { return -1 }
        if lhs > rhs { return 1 }
        return 0
    }
