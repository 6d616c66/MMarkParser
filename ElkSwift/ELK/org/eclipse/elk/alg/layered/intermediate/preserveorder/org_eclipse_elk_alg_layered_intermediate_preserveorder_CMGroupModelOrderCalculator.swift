...
internal class org_eclipse_elk_alg_layered_intermediate_preserveorder_CMGroupModelOrderCalculator {
    internal init() {}

    internal class func calculateModelOrderOrGroupModelOrder(
