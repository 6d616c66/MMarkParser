...
internal final class org_eclipse_elk_alg_layered_options_Spacings {
    ...
    internal func getHorizontalSpacing(_ e1: LGraphElement, _ e2: LGraphElement) -> Double {
    ...
    internal func getHorizontalSpacing(_ n1: LNode, _ n2: LNode) -> Double {
        return getLocalSpacing(n1, n2, nodeTypeSpacingOptionsHorizontal)
    }

    internal func getHorizontalSpacing(_ nt1: NodeType, _ nt2: NodeType) -> Double {
        return getLocalSpacing(nt1, nt2, nodeTypeSpacingOptionsHorizontal)
    }

    internal func getVerticalSpacing(_ n1: LNode, _ n2: LNode) -> Double {
        return getLocalSpacing(n1, n2, nodeTypeSpacingOptionsVertical)
    }

    internal func getVerticalSpacing(_ nt1: NodeType, _ nt2: NodeType) -> Double {
    ...
    internal static func getIndividualOrDefault(_ node: LNode, _ property: IProperty) -> Double {
