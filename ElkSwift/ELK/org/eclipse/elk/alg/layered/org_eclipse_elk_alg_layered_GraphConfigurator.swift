...
internal class LabelManagementOptions {
    internal static let LABEL_MANAGER = Property<Any?>("org.eclipse.elk.labels.labelManager")
}
...
internal class Random {
    ...
    internal func nextInt(_ bound: Int) -> Int {
    ...
    internal func nextLong() -> Int64 {
        let result = (Int64(next(32)) << 32) + Int64(next(32))

        return result
    }

    internal func nextBoolean() -> Bool {
        let result = next(1) != 0
    ...
    internal func setSeed(_ seed: Int) {
...
internal final class GraphConfigurator {
    
    // Constants
    
    /** intermediate processing configuration for basic graphs. */
    internal static let BASELINE_PROCESSING_CONFIGURATION: LayoutProcessorConfiguration<LayeredPhases, LGraph> =
    ...
    internal static let LABEL_MANAGEMENT_ADDITIONS: LayoutProcessorConfiguration<LayeredPhases, LGraph> =
        LayoutProcessorConfiguration<LayeredPhases, LGraph>.create()
    ...
    internal static let HIERARCHICAL_ADDITIONS: LayoutProcessorConfiguration<LayeredPhases, LGraph> =
        LayoutProcessorConfiguration<LayeredPhases, LGraph>.create()
    ...
    internal let algorithmAssembler: AlgorithmAssembler<LayeredPhases, LGraph> =
    ...
    internal static let MIN_EDGE_SPACING: Double = 2.0
     ...
     */
    internal func configureGraphProperties(_ lgraph: LGraph) {
    ...
    internal func copyPortContraints(_ lgraph: LGraph) {
    ...
    internal func copyPortConstraints(_ node: LNode) {
     ...
     */
    internal func prepareGraphForLayout(_ lgraph: LGraph) {
     ...
     */
    internal func getPhaseIndependentLayoutProcessorConfiguration(_ lgraph: LGraph) -> LayoutProcessorConfiguration<LayeredPhases, LGraph>? {
     ...
     */
    internal static func activateGreedySwitchFor(_ lgraph: LGraph) -> Bool {
    ...
    internal static func isHierarchicalLayout(_ lgraph: LGraph) -> Bool {
    ...
    internal static func resolveEdgeRouting(_ lgraph: LGraph) -> EdgeRouting {
