...
internal final class org_eclipse_elk_alg_layered_p1cycles_BFSNodeOrderCycleBreaker {
    ...
    internal var sinks: [org_eclipse_elk_alg_layered_graph_LNode] = []
    internal var sourceIds: Set<ObjectIdentifier> = []
    internal var sinkIds: Set<ObjectIdentifier> = []
    internal var visited: [Bool] = []
    internal var bfsQueue = ArrayDeque<org_eclipse_elk_alg_layered_graph_LNode>()
    ...
    internal func bfs(_ node: org_eclipse_elk_alg_layered_graph_LNode) {
        let nodeId = node.id
...
internal protocol _BFSNodeOrderCycleBreakerProgressMonitorCompat {
