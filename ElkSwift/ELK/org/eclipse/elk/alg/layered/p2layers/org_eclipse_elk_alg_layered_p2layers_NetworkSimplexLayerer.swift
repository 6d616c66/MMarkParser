...
internal final class org_eclipse_elk_alg_layered_p2layers_NetworkSimplexLayerer {
    ...
    internal func getLayoutProcessorConfiguration(_ graph: LGraph) -> LayoutProcessorConfiguration<LayeredPhases, LGraph>? {
