...
internal class org_eclipse_elk_alg_layered_p3order_counting_HyperedgeCrossingsCounter {
    internal let inLayerEdgeCount: [Int]
    internal let hasNorthSouthPorts: [Bool]
