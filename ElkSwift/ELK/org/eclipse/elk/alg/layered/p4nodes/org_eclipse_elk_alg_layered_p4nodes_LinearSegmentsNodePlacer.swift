...
internal final class org_eclipse_elk_alg_layered_p4nodes_LinearSegmentsNodePlacer {
    /// A linear segment contains a single regular node or all dummy nodes of a long edge.
    internal final class LinearSegment: Comparable, Hashable, CustomStringConvertible {
        ...
        internal weak var refSegment: LinearSegment?

        /// The nodetype contained in this linear segment.
        internal var nodeType: org_eclipse_elk_alg_layered_graph_NodeType = .NORMAL

        internal init() {}

        /// Determine the reference segment for the region to which this segment is associated.
        internal func region() -> LinearSegment {
        ...
        internal static func < (lhs: LinearSegment, rhs: LinearSegment) -> Bool {
            lhs.id < rhs.id
        }
    ...
    internal static let INPUT_PRIO = "linearSegments.inputPrio"

    /// Property for maximal priority of outgoing edges.
    internal static let OUTPUT_PRIO = "linearSegments.outputPrio"

    internal static let THRESHOLD_FACTOR: Double = 20.0
    internal static let PENDULUM_ITERS: Int = 4
    internal static let FINAL_ITERS: Int = 3
    internal static let OVERLAP_DETECT: Double = 0.0001

    /// Array of sorted linear segments.
    internal var linearSegments: [LinearSegment] = []
    ...
    @discardableResult
    internal func sortLinearSegments(
        _ layeredGraph: org_eclipse_elk_alg_layered_graph_LGraph,
        _ monitor: any org_eclipse_elk_core_util_IElkProgressMonitor
    ) -> [LinearSegment] {
    ...
    internal func createDependencyGraphEdges(
        _ monitor: any org_eclipse_elk_core_util_IElkProgressMonitor,
        _ layeredGraph: org_eclipse_elk_alg_layered_graph_LGraph,
    ...
    internal func createUnbalancedPlacement(_ layeredGraph: org_eclipse_elk_alg_layered_graph_LGraph) {
    ...
    internal func balancePlacement(_ layeredGraph: org_eclipse_elk_alg_layered_graph_LGraph) {
    ...
    @discardableResult
    internal func mergeRegions(_ layeredGraph: org_eclipse_elk_alg_layered_graph_LGraph) -> Bool {
        var changed = false
    ...
    internal func postProcess(_ layeredGraph: org_eclipse_elk_alg_layered_graph_LGraph) {
        _ = layeredGraph
    ...
    internal func segmentForNode(_ node: org_eclipse_elk_alg_layered_graph_LNode) -> LinearSegment? {
