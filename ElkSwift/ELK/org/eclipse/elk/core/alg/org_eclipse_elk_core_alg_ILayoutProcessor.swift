 ...
 */
internal protocol ILayoutProcessor: AnyGraphProcessorWrappable {
...
///    ```swift
///    internal static func fgraph<P: ILayoutProcessor>(_ processor: P, ...) -> AnyGraphProcessor
///    where P.G == FGraph { ... }
///    ```
///
...
///        internal func asAnyGraphProcessor(isHierarchyAware: Bool) -> AnyGraphProcessor {
...
internal protocol AnyGraphProcessorWrappable {
...
internal struct AnyGraphProcessor {
    ...
    internal let isHierarchyAware: Bool
    ...
    internal static func lgraph<P: ILayoutProcessor>(_ processor: P,
    ...
    internal static func wrapping(_ processor: Any) -> AnyGraphProcessor {
    ...
    internal func process(_ graph: Any, _ monitor: IElkProgressMonitor) {
