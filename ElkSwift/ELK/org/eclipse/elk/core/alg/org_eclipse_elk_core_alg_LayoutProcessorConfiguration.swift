 ...
 */
internal final class LayoutProcessorConfiguration<P: Hashable, G> where P: RawRepresentable, P.RawValue: Hashable {
    
    internal var processorLists: [[any ILayoutProcessorFactory]]
     ...
     */
    internal static func create() -> LayoutProcessorConfiguration<P, G> {
     ...
     * @return new layout processor configuration.
     */
    internal static func create(from source: LayoutProcessorConfiguration<P, G>) -> LayoutProcessorConfiguration<P, G> {
     ...
     */
    internal func clear() -> LayoutProcessorConfiguration<P, G> {
     ...
     * @return this configuration to enable method chaining.
     */
    internal func before(_ phase: P) -> LayoutProcessorConfiguration<P, G> {
     ...
     * @return this configuration to enable method chaining.
     */
    internal func after(_ phase: P) -> LayoutProcessorConfiguration<P, G> {
     ...
     */
    internal func add(_ processor: any ILayoutProcessorFactory) throws -> LayoutProcessorConfiguration<P, G> {
     ...
     */
    @discardableResult
    internal func addBefore(_ phase: P, _ processor: any ILayoutProcessorFactory) -> LayoutProcessorConfiguration<P, G> {
        currentIndex = -1
     ...
     */
    @discardableResult
    internal func addAfter(_ phase: P, _ processor: any ILayoutProcessorFactory) -> LayoutProcessorConfiguration<P, G> {
        currentIndex = -1
     ...
     *            the processor to add.
     */
    internal func doAdd(index: Int, processor: any ILayoutProcessorFactory) throws {
     ...
     */
    @discardableResult
    internal func addAll(_ configuration: LayoutProcessorConfiguration<P, G>) -> LayoutProcessorConfiguration<P, G> {
     ...
     */
    internal func processors(before phase: P) -> [any ILayoutProcessorFactory] {
     ...
     * @return set of processors.
     */
    internal func processors(after phase: P) -> [any ILayoutProcessorFactory] {
     ...
     * @return set of processors.
     */
    internal func processors(index: Int) -> [any ILayoutProcessorFactory] {
