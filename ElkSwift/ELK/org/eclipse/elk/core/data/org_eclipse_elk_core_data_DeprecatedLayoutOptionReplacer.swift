 ...
 */
internal class DeprecatedLayoutOptionReplacer: IGraphElementVisitor {
    ...
    internal static let nextToPortIfPossible: (ElkGraphElement) -> Void = { e in
     ...
     */
    @available(*, deprecated, message: "Deprecated")
    internal static let spaceEfficient: (ElkGraphElement) -> Void = { e in
     ...
     */
    @available(*, deprecated, message: "Deprecated")
    internal static let rules: [(IProperty, (ElkGraphElement) -> Void)] = [
