 ...
 */
internal protocol ILayoutMetaDataProvider {
 ...
 */
internal protocol ILayoutMetaDataProvider_Registry {
...
extension ILayoutMetaDataProvider {
    internal typealias Registry = ILayoutMetaDataProvider_Registry
}
