 ...
 * </p>
 */
internal protocol ILabelManager {
     ...
     * @return the label's dimensions after shortening or `nil` if the label has not been
     *         shortened.
     */
    func manageLabelSize(_ label: Any, targetWidth: Double) -> KVector?
