 ...
 */
internal class CubicSplineInterpolator: ISplineInterpolator {
     ...
     * the values of m = 7
     */
    internal static let INTERP_COEF_EVEN: [[Double]] = [
        [0.25],
        [0.2677, -0.0667],
     ...
     * the values of m = 7
     */
    internal static let INTERP_COEF_ODD: [[Double]] = [
        [0.3333],
        [0.2727, -0.0909],
    ...
    internal static let MAX_K = 7
    
    /** factor describing the length a in/outgoing vector is scaled. */
    internal static let TANGENT_SCALE: Double = 0.25
     ...
     */
    internal func calculateClosedBezierSpline(_ points: [KVector]) -> BezierSpline {
     ...
     * @return piecewise bezier spline
     */
    internal func calculateOpenBezierSpline(_ points: [KVector]) -> BezierSpline {
     ...
     * @return piecewise bezier spline
     */
    internal func calculateOpenBezierSpline(_ points: [KVector], _ startTan: KVector, _ endTan: KVector, _ tangentScale: Bool) -> BezierSpline {
    ...
    internal func interpolatePoints(_ points: [KVector]) -> BezierSpline {
        return calculateOpenBezierSpline(points)
    }

    internal func interpolatePoints(_ points: [KVector], _ startVec: KVector, _ endVec: KVector, _ tangentScale: Bool) -> BezierSpline {
