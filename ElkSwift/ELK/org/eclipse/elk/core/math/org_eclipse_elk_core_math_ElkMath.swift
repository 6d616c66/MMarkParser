...
// *******************************************************************************/
//internal org.eclipse.elk.core.math;
...
internal final class ElkMath {
    ...
    internal static let factTable: [Int64] = [ 1, 1, 2, 6, 24, 120, 720, 5040, 40320,
    ...
    // *             if x<0 or x>20
    // */
    internal static func factl(_ x: Int) -> Int64 {
    ...
    // *             if x<0
    // */
    internal static func factd(_ x: Int) -> Double {
    ...
    // */
    internal static func binomiall(_ n: Int, _ k: Int) -> Int64 {
        if n < 0 || k < 0 {
    ...
    // *             if n < 0 or n < 0 or k > n
    // */
    internal static func binomiald(_ n: Int, _ k: Int) -> Double {
        if n < 0 || k < 0 {
            assertionFailure("k and n must be positive")
            return 0
        } else if k > n {
    ...
    // */
    internal static func powd(_ a: Double, _ b: Int) -> Double {
        var result = 1.0
        var base = a
        var exp = (b >= 0 ? b : -b)
        while exp > 0 {
    ...
    // * @return a to the power of b
    // */
    internal static func powf(_ a: Float, _ b: Int) -> Float {
    ...
    // */
    internal static func approximateBezierSegment(_ resultSize: Int, _ controlPoints: KVector...) -> [KVector] {
        return approximateBezierSegmentArray(resultSize, controlPoints)
    }

    internal static func approximateBezierSegmentArray(_ resultSize: Int, _ controlPoints: [KVector]) -> [KVector] {
        if resultSize <= 0 {
            return []
        }
        var result = [KVector]()
    ...
    // * @return points on the curve defined by the given control points
    // */
    internal static func approximateBezierSegment(_ controlPoints: KVector...) -> [KVector] {
    ...
    // */
    internal static func getPointOnBezierSegment(_ t: Double, _ controlPoints: [KVector]) -> KVector {
    ...
    // */
    internal static func approximateBezierSpline(_ controlPoints: KVectorChain) -> KVectorChain {
    ...
    // */
    internal static func distanceFromBezierSegment(_ start: KVector, _ c1: KVector,
    ...
    ///** cubic Bezier curves. */
    internal static let degree = 3
    ///** precomputed "z" for cubics. */
    internal static let cubicZ: [[Double]] = [ [1.0, 0.6, 0.3, 0.1], [0.4, 0.6, 0.6, 0.4],
            [0.1, 0.3, 0.6, 1.0], ]
    ...
    // */
    internal static func convertToBezierForm(_ v: [KVector], _ pa: KVector) -> [KVector] {
    ...
    // */
    internal static func findRoots(_ w: [KVector], _ degree: Int, _ t: inout [Double], _ depth: Int) -> Int {
    ...
    ///** Flatness. */
    internal static let epsilon = 1.0 * pow(2.0, Double(-maxDepth - 1))
    
    ///**
    // * Check if the control polygon of a Bezier curve is flat enough for recursive subdivision to
    // * bottom out.
    // */
    internal static func controlPolygonFlatEnough(_ v: [KVector], _ degree: Int) -> Bool {
    ...
    // */
    internal static func computeXIntercept(_ v: [KVector], _ degree: Int) -> Double {
    ...
    // * number of roots.
    // */
    internal static func crossingCount(_ v: [KVector], _ degree: Int) -> Int {
        var nCrossings = 0
    ...
    // */
    internal static func bezier(_ c: [KVector], _ degree: Int, _ t: Double,
    ...
    // */
    internal static func maxi(_ values: Int...) -> Int {
        var max = Int.min
    ...
    // */
    internal static func mini(_ values: Int...) -> Int {
        var min = Int.max
        for i in 0..<values.count {
            if values[i] < min {
                min = values[i]
    ...
    // */
    internal static func averagei(_ values: Int...) -> Int {
        var avg = 0
        for i in 0..<values.count {
            avg += values[i]
        }
    ...
    // * @return the maximum of the given values, or {@code MIN_VALUE} if no values are given
    // */
    internal static func maxl(_ values: Int64...) -> Int64 {
        var max = Int64.min
        for i in 0..<values.count {
            if values[i] > max {
                max = values[i]
    ...
    // * @return the minimum of the given values, or {@code MAX_VALUE} if no values are given
    // */
    internal static func minl(_ values: Int64...) -> Int64 {
        var min = Int64.max
        for i in 0..<values.count {
            if values[i] < min {
                min = values[i]
    ...
    // * @return the average of the given values
    // */
    internal static func averagel(_ values: Int64...) -> Int64 {
        var avg: Int64 = 0
        for i in 0..<values.count {
            avg += values[i]
        }
    ...
    // */
    internal static func maxf(_ values: Float...) -> Float {
    ...
    // * @return the minimum of the given values, or {@code MAX_VALUE} if no values are given
    // */
    internal static func minf(_ values: Float...) -> Float {
    ...
    // * @return the average of the given values
    // */
    internal static func averagef(_ values: Float...) -> Float {
        var avg: Float = 0
        for i in 0..<values.count {
            avg += values[i]
        }
    ...
    // * @return the maximum of the given values, or {@code -MAX_VALUE} if no values are given
    // */
    internal static func maxd(_ values: Double...) -> Double {
    ...
    // * @return the minimum of the given values, or {@code MAX_VALUE} if no values are given
    // */
    internal static func mind(_ values: Double...) -> Double {
    ...
    // * @return the average of the given values
    // */
    internal static func averaged(_ values: Double...) -> Double {
        var avg: Double = 0
        for i in 0..<values.count {
            avg += values[i]
        }
    ...
    // */
    internal static func boundi(_ x: Int, _ lower: Int, _ upper: Int) -> Int {
        if x <= lower {
            return lower
        } else if x >= upper {
            return upper
    ...
    // * @return if x is beyond the limits, return the limit, otherwise just return x
    // */
    internal static func boundl(_ x: Int64, _ lower: Int64, _ upper: Int64) -> Int64 {
        if x <= lower {
            return lower
        } else if x >= upper {
            return upper
    ...
    // * @return if x is beyond the limits, return the limit, otherwise just return x
    // */
    internal static func boundf(_ x: Float, _ lower: Float, _ upper: Float) -> Float {
        if x <= lower {
            return lower
        } else if x >= upper {
            return upper
    ...
    // * @return if x is beyond the limits, return the limit, otherwise just return x
    // */
    internal static func boundd(_ x: Double, _ lower: Double, _ upper: Double) -> Double {
        if x <= lower {
            return lower
        } else if x >= upper {
            return upper
    ...
    // * @return {@code v}.
    // */
    internal static func clipVector(_ v: KVector, _ width: Double, _ height: Double) -> KVector {
    ...
    // */
    internal static func signum(_ x: Double) -> Int {
        if x < 0 {
            return -1
        }
        if x > 0 {
    ...
    // */
    internal static func intersects(_ rect: ElkRectangle, _ path: KVectorChain) -> Bool {
        if path.size() < 2 {
            return false
        }
    ...
    // */
    internal static func intersects(_ rect: ElkRectangle, _ p1: KVector, _ p2: KVector) -> Bool {
    ...
    // */
    internal static let doubleEqEpsilon = 0.00001
    ...
    // */
    internal static func intersects(_ l11: KVector, _ l12: KVector, _ l21: KVector, _ l22: KVector) -> Bool {
        let u0 = l11
    ...
    // */
    internal static func intersects2(_ p: KVector, _ r: KVector, _ q: KVector, _ s: KVector) -> KVector? {
    ...
    // */
    internal static func distance(_ a1: KVector, _ a2: KVector, _ b1: KVector, _ b2: KVector, 
            _ v: KVector) -> Double {
    ...
    // */
    internal static func traceRays(_ a1: KVector, _ a2: KVector, _ b1: KVector, _ b2: KVector, 
            _ v: KVector) -> Double {
    ...
    // */
    internal static func contains(_ rect: ElkRectangle, _ path: KVectorChain) -> Bool {
        if path.size() < 2 {
            return false
        }
    ...
    // */
    internal static func contains(_ rect: ElkRectangle, _ p1: KVector, _ p2: KVector) -> Bool {
    ...
    // */
    internal static func contains(_ rect: ElkRectangle, _ p: KVector) -> Bool {
        let minX = rect.x
    ...
    // */
    internal static func shortestDistance(_ r1: ElkRectangle, _ r2: ElkRectangle) -> Double {
