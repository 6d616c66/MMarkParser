 ...
 */
internal final class KVector: Hashable, CustomStringConvertible, CustomDebugStringConvertible {
    
    /** the default fuzzyness used when comparing two vectors fuzzily. */
    internal static let defaultFuzziness: Double = 0.05
    ...
    internal var width: Double { get { x } set { x = newValue } }
    /// Alias so KVector can be used to represent sizes (height maps to y).
    internal var height: Double { get { y } set { y = newValue } }
     ...
     * @param y y value
     */
    internal init(_ x: Double, _ y: Double) {
        self.x = x
        self.y = y
    }
     ...
     */
    internal init(_ start: KVector, _ end: KVector) {
    ...
    internal static func == (lhs: KVector, rhs: KVector) -> Bool {
     ...
     */
    internal func equalsFuzzily(_ other: KVector) -> Bool {
     ...
     * @return {@code true} if the vectors are approximately equal, {@code false} otherwise.
     */
    internal func equalsFuzzily(_ other: KVector, _ fuzzyness: Double) -> Bool {
     ...
     * @return x*x + y*y
     */
    internal func squareLength() -> Double {
        return x * x + y * y
    }
     ...
     */
    @discardableResult
    internal func set(_ other: KVector) -> KVector {
        self.x = other.x
        self.y = other.y
        return self
    }
     ...
     */
    @discardableResult
    internal func set(_ newX: Double, _ newY: Double) -> KVector {
        self.x = newX
        self.y = newY
        return self
    }
     ...
     */
    @discardableResult
    internal func add(_ v: KVector) -> KVector {
        self.x += v.x
        self.y += v.y
        return self
    }
     ...
     */
    @discardableResult
    internal func add(_ dx: Double, _ dy: Double) -> KVector {
        self.x += dx
        self.y += dy
        return self
    }
     ...
     */
    internal static func sum(_ vs: KVector...) -> KVector {
        var sum = KVector()
        for v in vs {
            sum.x += v.x
            sum.y += v.y
     ...
     */
    @discardableResult
    internal func sub(_ v: KVector) -> KVector {
        self.x -= v.x
        self.y -= v.y
        return self
    }
     ...
     */
    @discardableResult
    internal func sub(_ dx: Double, _ dy: Double) -> KVector {
        self.x -= dx
        self.y -= dy
        return self
    }
     ...
     */
    internal static func diff(_ v1: KVector, _ v2: KVector) -> KVector {
     ...
     */
    @discardableResult
    internal func scale(_ scale: Double) -> KVector {
        self.x *= scale
        self.y *= scale
        return self
    }
     ...
     */
    @discardableResult
    internal func scale(_ scalex: Double, _ scaley: Double) -> KVector {
        self.x *= scalex
        self.y *= scaley
        return self
    }
     ...
     */
    @discardableResult
    internal func normalize() -> KVector {
     ...
     */
    @discardableResult
    internal func scaleToLength(_ length: Double) -> KVector {
        self.normalize()
        self.scale(length)
        return self
    }
     ...
     */
    internal func toDegrees() -> Double {
     ...
     */
    internal func toRadians() -> Double {
        let length = self.length()
     ...
     */
    @discardableResult
    internal func wiggle(_ random: inout some RandomNumberGenerator, _ amount: Double) {
     ...
     */
    internal func distance(_ v2: KVector) -> Double {
        let dx = self.x - v2.x
        let dy = self.y - v2.y
     ...
     */
    internal func dotProduct(_ v2: KVector) -> Double {
     ...
     */
    internal static func crossProduct(_ v: KVector, _ w: KVector) -> Double {
     ...
     */
    @discardableResult
    internal func rotate(_ angle: Double) -> KVector {
     ...
     */
    internal func angle(_ other: KVector) -> Double {
     ...
     */
    @discardableResult
    internal func bound(_ lowx: Double, _ lowy: Double, _ highx: Double, _ highy: Double) throws -> KVector {
     ...
     */
    internal func isDelimiter(_ c: Character) -> Bool {
    ...
    @discardableResult
    internal func add(x dx: Double, y dy: Double) -> KVector {
        return add(dx, dy)
    }

    @discardableResult
    internal func sub(x dx: Double, y dy: Double) -> KVector {
        return sub(dx, dy)
    }

    @discardableResult
    internal func set(x newX: Double, y newY: Double) -> KVector {
        return set(newX, newY)
    }

    @discardableResult
    internal func scale(x scalex: Double, y scaley: Double) -> KVector {
    ...
    @discardableResult
    internal func scaleToLength(toLength length: Double) -> KVector {
