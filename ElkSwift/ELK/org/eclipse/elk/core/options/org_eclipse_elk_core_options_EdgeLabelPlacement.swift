 ...
 */
internal enum EdgeLabelPlacement {
     ...
     */
    internal func isEndLabelPlacement() -> Bool {
        return self == .head || self == .tail
    }

    // MARK: - Uppercase Aliases (Java compatibility)
    internal static let CENTER = EdgeLabelPlacement.center
    internal static let HEAD = EdgeLabelPlacement.head
    internal static let TAIL = EdgeLabelPlacement.tail
}
