...
internal enum HierarchyHandling {
    ...
    internal static let INHERIT = HierarchyHandling.inherit
    internal static let INCLUDE_CHILDREN = HierarchyHandling.includeChildren
    internal static let SEPARATE_CHILDREN = HierarchyHandling.separateChildren
}
