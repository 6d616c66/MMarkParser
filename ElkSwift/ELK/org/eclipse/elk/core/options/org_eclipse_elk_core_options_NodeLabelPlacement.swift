...
internal struct NodeLabelPlacement: OptionSet, Hashable {
    ...
    internal static let hLeft = NodeLabelPlacement(rawValue: 1 << 0)
    
    /// Horizontal center placement.
    internal static let hCenter = NodeLabelPlacement(rawValue: 1 << 1)
    
    /// Horizontal right placement.
    internal static let hRight = NodeLabelPlacement(rawValue: 1 << 2)
    
    /// Vertical top placement.
    internal static let vTop = NodeLabelPlacement(rawValue: 1 << 3)
    
    /// Vertical center placement.
    internal static let vCenter = NodeLabelPlacement(rawValue: 1 << 4)
    
    /// Vertical bottom placement.
    internal static let vBottom = NodeLabelPlacement(rawValue: 1 << 5)
    ...
    internal static let inside = NodeLabelPlacement(rawValue: 1 << 6)
    
    /// Place node labels on the outside of the node.
    internal static let outside = NodeLabelPlacement(rawValue: 1 << 7)
    ...
    internal static let hPriority = NodeLabelPlacement(rawValue: 1 << 8)
    ...
    internal static func fixed() -> NodeLabelPlacement {
        return []
    }
    ...
    internal static func insideTopLeft() -> NodeLabelPlacement {
    ...
    internal static func insideTopCenter() -> NodeLabelPlacement {
    ...
    internal static func insideTopRight() -> NodeLabelPlacement {
    ...
    internal static func insideCenter() -> NodeLabelPlacement {
    ...
    internal static func insideBottomLeft() -> NodeLabelPlacement {
    ...
    internal static func insideBottomCenter() -> NodeLabelPlacement {
    ...
    ///
    /// - Returns: node label placement for inside top right placement.
    internal static func insideBottomRight() -> NodeLabelPlacement {
    ...
    internal static func outsideTopLeft() -> NodeLabelPlacement {
    ...
    internal static func outsideTopCenter() -> NodeLabelPlacement {
    ...
    ///
    /// - Returns: node label placement for outside top left placement.
    internal static func outsideTopRight() -> NodeLabelPlacement {
    ...
    ///
    /// - Returns: node label placement for outside top left placement.
    internal static func outsideBottomLeft() -> NodeLabelPlacement {
    ...
    internal static func outsideBottomCenter() -> NodeLabelPlacement {
    ...
    ///
    /// - Returns: node label placement for outside top left placement.
    internal static func outsideBottomRight() -> NodeLabelPlacement {
    ...
    internal static func isValid(_ placement: NodeLabelPlacement) -> Bool {
