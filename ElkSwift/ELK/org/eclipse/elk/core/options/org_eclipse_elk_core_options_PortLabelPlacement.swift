 ...
 */
internal struct PortLabelPlacement: OptionSet, Hashable {
    ...
    internal static let outside = PortLabelPlacement(rawValue: 1 << 0)
    
    /** Port labels are placed inside of the node. */
    internal static let inside = PortLabelPlacement(rawValue: 1 << 1)
     ...
     */
    internal static let nextToPortIfPossible = PortLabelPlacement(rawValue: 1 << 2)
     ...
     */
    internal static let alwaysSameSide = PortLabelPlacement(rawValue: 1 << 3)
     ...
     * Note: the option does not apply to inside port labels (unless a hierarchical edge connects).
     */
    internal static let alwaysOtherSameSide = PortLabelPlacement(rawValue: 1 << 4)
     ...
     * Note: the option does not apply to inside port labels (unless a hierarchical edge connects).
     */
    internal static let spaceEfficient = PortLabelPlacement(rawValue: 1 << 5)
    
    /**
     * @return a set of `PortLabelPlacement` values indicating fixed port label positions.
     */
    internal static var fixed: PortLabelPlacement {
        return []
    }
     ...
     */
    internal static var insideSet: PortLabelPlacement {
        return .inside
    }
     ...
     */
    internal static var outsideSet: PortLabelPlacement {
        return .outside
    }
     ...
     */
    internal static func isFixed(_ placement: PortLabelPlacement) -> Bool {
     ...
     */
    internal static func isValid(_ placement: PortLabelPlacement) -> Bool {
