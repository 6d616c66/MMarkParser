 ...
 * @author cds
 */
internal struct SizeConstraint: OptionSet, Hashable {
     ...
     */
    internal static let ports = SizeConstraint(rawValue: 1 << 0)
     ...
     */
    internal static let portLabels = SizeConstraint(rawValue: 1 << 1)
    
    /**
     * A node's labels are taken into account.
     */
    internal static let nodeLabels = SizeConstraint(rawValue: 1 << 2)
     ...
     * set as well.
     */
    internal static let minimumSize = SizeConstraint(rawValue: 1 << 3)
     ...
     */
    internal static var fixed: SizeConstraint { [] }
     ...
     */
    internal static var minimumSizeOnly: SizeConstraint { [.minimumSize] }
     ...
     */
    internal static var minimumSizeWithPorts: SizeConstraint { [.ports, .minimumSize] }
     ...
     */
    internal static var free: SizeConstraint { [.ports, .portLabels, .nodeLabels, .minimumSize] }
}
