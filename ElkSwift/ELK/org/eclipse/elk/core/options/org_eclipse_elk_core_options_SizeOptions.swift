 ...
 * @author cds
 */
internal struct SizeOptions: OptionSet, Hashable {
     ...
     */
    internal static let defaultMinimumSize = SizeOptions(rawValue: 1 << 0)
     ...
     */
    internal static let minimumSizeAccountsForPadding = SizeOptions(rawValue: 1 << 1)
     ...
     */
    internal static let computePadding = SizeOptions(rawValue: 1 << 2)
     ...
     */
    internal static let outsideNodeLabelsOverhang = SizeOptions(rawValue: 1 << 3)
     ...
     */
    internal static let portsOverhang = SizeOptions(rawValue: 1 << 4)
     ...
     */
    internal static let uniformPortSpacing = SizeOptions(rawValue: 1 << 5)
    
    /**
     * @deprecated Use `PortLabelPlacement.spaceEfficient`.
     */
    @available(*, deprecated, message: "Use PortLabelPlacement.spaceEfficient")
    internal static let spaceEfficientPortLabels = SizeOptions(rawValue: 1 << 6)
     ...
     */
    internal static let forceTabularNodeLabels = SizeOptions(rawValue: 1 << 7)
     ...
     */
    internal static let asymmetrical = SizeOptions(rawValue: 1 << 8)
     ...
     */
    internal static func value(ofOrdinal i: Int) -> SizeOptions {
