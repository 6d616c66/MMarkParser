 ...
 * in the final result.
 */
internal enum TopdownSizeApproximator: ITopdownSizeApproximator {
    ...
    internal func getSize(_ node: any ElkNode) throws -> KVector {
        switch self {
        case .countChildren:
    ...
    internal func getSizeForCountChildren(_ node: any ElkNode) -> KVector {
    ...
    internal func getSizeForLookaheadLayout(_ originalGraph: any ElkNode) throws -> KVector {
    ...
    internal func getSizeForFixedIntegerRatioBoxes(_ originalGraph: any ElkNode) -> KVector {
    ...
    internal func getSizeForLayoutNextLevel(_ originalGraph: any ElkNode) throws -> KVector {
