 ...
 */
internal class TopdownSizeApproximatorUtil {
     ...
     */
    internal static func getSizeCategoryMultiplier(_ originalGraph: any ElkNode) -> Double {
     ...
     */
    internal static func getGraphSize(_ originalGraph: any ElkNode) -> Int {
        var sum = 0
