 ...
 */
internal final class ElkUtil {
    
    /**
     * Default minimal width for nodes.
     */
    internal static let DEFAULT_MIN_WIDTH: Double = 20.0
    
    /**
     * Default minimal height for nodes.
     */
    internal static let DEFAULT_MIN_HEIGHT: Double = 20.0
     ...
     */
    internal static func calcPortSide(_ port: ElkPort, direction: Direction) -> PortSide {
     ...
     * @throws IllegalStateException if the port does not have a parent node.
     */
    internal static func calcPortOffset(_ port: ElkPort, side: PortSide) -> Double {
        guard let node = port.parent else {
     ...
     */
    @discardableResult
    internal static func resizeNode(_ node: ElkNode) -> KVector? {
     ...
     */
    @discardableResult
    internal static func resizeNode(_ node: ElkNode, newWidth: Double, newHeight: Double, movePorts: Bool, moveLabels: Bool) -> KVector {
     ...
     */
    internal static func effectiveMinSizeConstraintFor(_ node: ElkNode) -> KVector {
        let sizeConstraint: SizeConstraint = node.getProperty(CoreOptions.NODE_SIZE_CONSTRAINTS) ?? []
     ...
     */
    internal static func applyConfiguredNodeScaling(_ node: ElkNode) {
     ...
     */
    internal static func computeChildAreaDimensions(_ node: ElkNode) {
     ...
     */
    internal static func determineJunctionPoints(_ edge: ElkEdge) -> KVectorChain {
     ...
     */
    internal static func determineJunctionPoints(_ edge: ElkEdge, _ port: ElkPort, _ reverse: Bool) -> KVectorChain {
     ...
     */
    internal static func getPoints(_ section: ElkEdgeSection) -> [KVector] {
     ...
     */
    internal static func translate(_ parent: ElkNode, xoffset: Double, yoffset: Double) {
     ...
     * @param yoffset y coordinate offset
     */
    internal static func translate(_ edge: ElkEdge, xoffset: Double, yoffset: Double) {
        // Edge sections
        for section in edge.sections {
     ...
     * @param yoffset y coordinate offset
     */
    internal static func translate(_ section: ElkEdgeSection, xoffset: Double, yoffset: Double) {
     ...
     */
    internal static func translate(_ parent: ElkNode, newSize: KVector, oldSize: KVector) {
     ...
     */
    internal static func absolutePosition(_ element: ElkGraphElement) -> KVector {
     ...
     */
    internal static func toAbsolute(_ point: KVector, parent: ElkNode?) -> KVector {
        var node = parent
     ...
     * @return {@code point} for convenience
     */
    internal static func toRelative(_ point: KVector, parent: ElkNode?) -> KVector {
        var node = parent
        var resultPoint = point
        while let currentNode = node {
            resultPoint.add(-currentNode.x, -currentNode.y)
     ...
     */
    internal static func createVectorChain(_ edgeSection: ElkEdgeSection) -> KVectorChain {
     ...
     */
    internal static func applyVectorChain(_ vectorChain: KVectorChain, section: ElkEdgeSection) {
     ...
     */
    internal static func configureDefaultsRecursively(_ graph: ElkNode) {
     ...
     *            a node of a graph
     */
    internal static func configureWithDefaultValues(_ node: ElkNode) {
     ...
     */
    internal static func configureWithDefaultValues(_ port: ElkPort) {
     ...
     *            an edge of a graph
     */
    internal static func configureWithDefaultValues(_ edge: ElkEdge) {
     ...
     * identifier.
     */
    internal static func ensureLabel(_ klge: ElkGraphElement) {
     ...
     */
    internal static func applyVisitors(_ graph: ElkNode, visitors: [IGraphElementVisitor]) throws {
     ...
     */
    internal static func applyVisitorsWithValidation(_ graph: ElkNode, visitors: [IGraphElementVisitor]) throws {
     ...
     */
    internal static func printElementPath(_ element: ElkGraphElement, builder: inout String) {
     ...
     */
    internal static func debugFolderPath(_ subfolders: [String] = []) -> String? {
     ...
     */
    internal static func toSafePathName(_ name: String) -> String {
     ...
     */
    internal static func createIdentifier(_ element: ElkGraphElement) {
    ...
    internal static func computeInsidePart(_ labelPos: KVector, _ labelSize: KVector,
    ...
    internal static func computeInsidePart(_ port: PortAdapter, _ portBorderOffset: Double) -> Double {
    ...
    internal static func getLabelsBounds(_ port: PortAdapter) -> ElkRectangle {
