...
internal struct LoggedGraph {
    internal enum GraphType { case elk, json, dot, svg }
    internal let graph: Any
    internal let graphType: GraphType
    internal let tag: String
    internal init(graph: Any, tag: String, graphType: GraphType) throws {
 ...
 */
internal protocol IElkProgressMonitor: IElkCancelIndicator {
