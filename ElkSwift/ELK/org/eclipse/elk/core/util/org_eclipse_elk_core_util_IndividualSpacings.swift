 ...
 */
internal class IndividualSpacings: MapPropertyHolder, IDataObject {
    
    /** Serialization identifier. */
    internal static let serialVersionUID: Int64 = 737614242607924309
     ...
     */
    internal init(_ other: IndividualSpacings) {
        super.init()
     ...
     */
    internal static func getIndividualOrInherited(_ node: ElkNode, _ property: IProperty) -> Any? {
        var result: Any? = nil
     ...
     * - Returns: the individual override for the property or the default value inherited by the parent node.
     */
    internal static func getIndividualOrInherited(_ node: NodeAdapterProtocol, _ property: IProperty) -> Any? {
        var result: Any? = nil
     ...
     */
    internal static func getIndividualOrInherited(_ node: NodeAdapter, _ property: IProperty) -> Any? {
        var result: Any? = nil
    ...
    internal static let serializedOptionSeparator = ";,;"
...
internal protocol NodeAdapterProtocol {
...
internal struct IPropertyKey<T> {
