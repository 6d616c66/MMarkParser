...
internal typealias PropertyValue = Any

// MARK: - Factory Protocol
// MARK: - Package Protocol

internal protocol ElkGraphPackage: EPackage {
...
internal protocol EAttribute {
    // Represents an attribute in the EMF model
}

internal protocol EReference {
    // Represents a reference in the EMF model
}

internal protocol EDataType {
