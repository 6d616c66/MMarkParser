 ...
 * 
 * <p><em>Note:</em>
 * Originally, this enumeration was to be found in the {@code properties} internal of the core plug-in. However,
...
internal enum GraphFeature {
    ...
    internal static let descriptions: [GraphFeature: String] = [
