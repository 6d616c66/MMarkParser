...
public struct MMarkStyleConfiguration {
    ...
    public struct TaskListStyle {
        ...
        public init(checkedColor: UIColor, uncheckedColor: UIColor) {
    ...
    public static var defaultStyle: MMarkStyleConfiguration {
        ...
        return MMarkStyleConfiguration(
            ...
            codeBlockStyle: CodeStyle(font: codeFont, textColor: .white, backgroundColor: .systemGray),
...
// 定义自定义 UTI
extension UTType {
    static var codeBlockType: UTType {
        UTType("com.mmarkparser.codeblock") ?? .aiff
    }

    static var tableBlockType: UTType {
        UTType("com.mmarkparser.table") ?? .jpeg
    }

    static var blockquoteBlockType: UTType {
        UTType("com.mmarkparser.blockquote") ?? .jpeg
    }

    static var mathBlockType: UTType {
        UTType("com.mmarkparser.mathblock") ?? .json
    }

    static var imageBlockType: UTType {
        UTType("com.mmarkparser.imageblock") ?? .jpeg
    }
}
