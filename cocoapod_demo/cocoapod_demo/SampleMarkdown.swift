...
let sampleMarkdown = """
    ...
    *斜体中包含 **粗体** 文本*
    ...
    ![测试图片1](https://img2.baidu.com/it/u=143424998,1290056484&fm=253&fmt=auto&app=120&f=JPEG?w=1422&h=800)

    ## 5.3 多图片连续显示

    ![图片A](https://img0.baidu.com/it/u=2593926744,4206835519&fm=253&fmt=auto&app=120&f=JPEG?w=1422&h=800)

    ![图片B](https://img2.baidu.com/it/u=245317613,842273138&fm=253&app=138&f=JPEG?w=800&h=800)

    ![图片C](https://img1.baidu.com/it/u=1586117827,413540105&fm=253&app=138&f=JPEG?w=800&h=800)
    ...
    ![](https://img1.baidu.com/it/u=1541393831,3588144036&fm=253&app=138&f=JPEG?w=800&h=800)
    ...
    ***
    ...
    脚注定义会自动出现在文档末尾。点击脚注引用（如 [^1]）可以跳转到脚注定义，点击脚注定义末尾的 ↩ 可以返回引用位置。
    ...
    - 包含图片引用的项目：![小图](https://img2.baidu.com/it/u=495474551,2367993711&fm=253&app=120&f=JPEG?w=1422&h=800)
